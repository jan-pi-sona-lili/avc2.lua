...
local function print_memory(from, to) --> nil
	...
	for i = (from or 0),(to or 0xffff) do
		write(hex(i,4),hex(m[i],2,1),(i==pc)and"<- pc"or"",(i==be[2]-wsp)and"<- wsp"or"",(i==be[3]-rsp)and"<- rsp"or"",(i==0x0306)and"*"or"",(i==0x0323)and">"or"","\n")
	end
	write("--------------","\n")
end
...
k: [k]eeps values on stack. (n1 n2 -- n1 n2 n1+n2)
